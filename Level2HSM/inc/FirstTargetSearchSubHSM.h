 ...
 * 
 */
#ifndef FIRST_TARGET_SEARCH_SUB_HSM_H  // <- This should be changed to your own guard on both
#define FIRST_TARGET_SEARCH_SUB_HSM_H  //    of these lines
...
#endif /* FIRST_TARGET_SEARCH_SubHSM_H */
