/*
 * File:   SecondTargetUnloadSubHSM.h
 * Author: jcrowley
 *
 ...
 * 
 */
#ifndef SECOND_TARGET_UNLOAD_SUB_HSM_H  // <- This should be changed to your own guard on both
#define SECOND_TARGET_UNLOAD_SUB_HSM_H  //    of these lines
...
/**
 * @Function InitSecondUnloadApproachSubHSM(uint8_t Priority)
...
#endif /* SECOND_TARGET_UNLOAD_SubHSM_H */
